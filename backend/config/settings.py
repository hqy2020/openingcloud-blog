...
ALLOWED_HOSTS = parse_csv_env(
    ...
    "127.0.0.1,localhost,testserver,47.99.42.71,blog.openingclouds.xyz,blog.oc.slgneon.cn",
)
...
CORS_DEFAULT = (
    ...
    if DEBUG
    else "https://blog.openingclouds.xyz,https://blog.oc.slgneon.cn"
)
CSRF_DEFAULT = (
    "http://localhost:5173,http://127.0.0.1:5173,http://47.99.42.71"
    if DEBUG
...
OBSIDIAN_IMAGES_REPO_BRANCH = os.getenv("OBSIDIAN_IMAGES_REPO_BRANCH", "main")
OBSIDIAN_IMAGES_REPO_PREFIX = os.getenv("OBSIDIAN_IMAGES_REPO_PREFIX", "gallery")
OBSIDIAN_IMAGES_COMMITTER_NAME = os.getenv("OBSIDIAN_IMAGES_COMMITTER_NAME", "")
OBSIDIAN_IMAGES_COMMITTER_EMAIL = os.getenv("OBSIDIAN_IMAGES_COMMITTER_EMAIL", "")
