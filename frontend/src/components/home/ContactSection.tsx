...
function GithubIcon() {
  return (
    <svg aria-hidden="true" className="h-12 w-12" fill="currentColor" viewBox="0 0 24 24">
...
function MailIcon() {
  return (
    <svg aria-hidden="true" className="h-12 w-12" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
    ...
    <FadeIn>
      <CardSpotlight className="relative rounded-2xl border border-slate-200/80 bg-white/90 p-6 shadow-[0_12px_32px_rgba(15,23,42,0.08)] backdrop-blur">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-8 sm:gap-14">
          ...
          >
            <span className="flex h-24 w-24 items-center justify-center rounded-full border border-slate-200 bg-[radial-gradient(circle_at_30%_25%,#ffffff,#e5e7eb)] shadow-[inset_0_0_0_10px_rgba(255,255,255,0.45),0_10px_24px_rgba(15,23,42,0.12)] transition duration-200 group-hover:scale-110 group-hover:text-[#4F6AE5] sm:h-28 sm:w-28">
              <MailIcon />
            </span>
          </a>
