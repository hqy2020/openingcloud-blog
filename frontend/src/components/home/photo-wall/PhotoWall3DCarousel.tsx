...
export function PhotoWall3DCarousel({ photos, onPreview }: PhotoWall3DCarouselProps) {
  return (
    <div className="relative h-[420px] overflow-hidden rounded-2xl border border-slate-200/80 bg-[linear-gradient(160deg,#f8fbff,#eef4ff)]">
      <Canvas dpr={[1, 1.5]} camera={{ position: [0, 1, 9.1], fov: 20 }}>
