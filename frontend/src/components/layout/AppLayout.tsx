...
function PulsatingSocialLink({
  ...
  return (
    <a
      ...
      aria-label={label}
      title={label}
      className="group relative inline-flex h-8 w-8 items-center justify-center overflow-hidden rounded-full bg-slate-50/90 text-slate-600 transition hover:bg-slate-100 hover:text-slate-800 lg:h-16 lg:w-16"
    >
...
function AdminEntryIcon() {
  return (
    <svg aria-hidden="true" className="h-[1.65rem] w-[1.65rem] lg:h-[3.3rem] lg:w-[3.3rem]" fill="none" viewBox="0 0 24 24">
...
function GithubIcon() {
  return (
    <svg aria-hidden="true" className="h-[1.65rem] w-[1.65rem] lg:h-[3.3rem] lg:w-[3.3rem]" fill="currentColor" viewBox="0 0 24 24">
      ...
      <header className="fixed inset-x-0 top-0 z-40">
        <div className="w-full">
          <motion.div
            ...
            className="relative z-[60] hidden w-full items-center justify-between overflow-hidden border-y border-slate-200/70 px-4 py-2 isolate lg:flex lg:px-8 lg:py-4"
          >
            ...
            <nav
              ...
              className="absolute inset-0 z-10 hidden items-center justify-center gap-1 text-sm font-medium lg:flex lg:gap-2 lg:text-xl"
            >
                ...
                if (item.nativeAnchor) {
                  return (
                    <a
                      key={item.label}
                      href={item.to}
                      className="relative rounded-full px-3 py-1.5 text-slate-600 transition hover:text-slate-900 lg:px-6 lg:py-3"
            ...
            <div className="relative z-20 flex items-center gap-1 lg:gap-2">
              ...
              <span className="mx-1 h-5 w-px bg-slate-200 lg:mx-2 lg:h-10" />
              <a
                href="/admin/"
                aria-label="后台管理"
                title="后台管理"
                className="inline-flex h-8 w-8 items-center justify-center rounded-full text-slate-600 transition hover:bg-slate-100 hover:text-slate-800 lg:h-16 lg:w-16"
              >
                <AdminEntryIcon />
              </a>
            </div>
