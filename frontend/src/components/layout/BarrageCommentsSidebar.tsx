    ...
    <SidePanel
      ...
      renderButton={(toggle, panelOpen) =>
        panelOpen ? (
          ...
          <button
            onClick={toggle}
            className="flex flex-col items-center gap-1.5 rounded-r-lg border border-l-0 border-slate-200/70 bg-white/90 px-1.5 py-3 shadow-sm backdrop-blur-xl transition-colors hover:bg-slate-50"
            aria-label="展开弹幕评论"
            type="button"
          >
