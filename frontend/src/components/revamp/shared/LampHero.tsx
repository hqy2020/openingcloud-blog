...
export function LampHero({ className, children }: LampHeroProps) {
  return (
    <div className={`relative overflow-hidden rounded-[32px] border border-theme-line/80 bg-theme-surface px-6 py-10 shadow-[0_28px_68px_rgba(15,23,42,0.14)] sm:px-10 ${className ?? ""}`}>
