...
export const fallbackHomePayload: HomePayload = {
  ...
  timeline: [
    ...
    {
      title: "CAD&CG 全国重点实验室 · 课题组学习",
      description: "在 CAD&CG 全国重点实验室从事知识管理与智能系统方向研究",
      start_date: "2024-09-01",
      end_date: "2026-03-01",
      type: "learning",
      impact: "high",
      phase: "硕士",
      tags: ["learning", "research", "lab"],
      cover: "",
      links: [],
      sort_order: 9.5,
    },
  ...
  highlights: [
    ...
    },
    {
      ...
      sort_order: 5,
      items: [
        { title: "CAD&CG 全国重点实验室", description: "", achieved_at: null, sort_order: 1 },
        { title: "CCF-B 一作", description: "", achieved_at: null, sort_order: 2 },
        { title: "CCF-A 二作", description: "", achieved_at: null, sort_order: 3 },
        { title: "两篇专利", description: "", achieved_at: null, sort_order: 4 },
        { title: "浙江大学优秀毕业生", description: "", achieved_at: null, sort_order: 5 },
      ],
    },
  ],
  travel: [
