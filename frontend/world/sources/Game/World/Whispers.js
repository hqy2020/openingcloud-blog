...
export class Whispers
{
    ...
    setMenu()
    {
        ...
        this.menu.input.addEventListener('input', () =>
        {
            ...
            this.menu.previewMessageText.textContent = sanatized.length ? sanatized : '你的留言'
        ...
        {
            const sanatized = sanatize(this.menu.input.value, true, true, true)
            this.menu.previewMessageText.textContent = sanatized !== '' ? sanatized : '你的留言'
            updateGroup()
        })
        ...
        {
            this.menu.previewMessageText.textContent = '你的留言'
